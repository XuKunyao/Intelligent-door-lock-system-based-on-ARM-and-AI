...
#linux平台opnecv和Seetaface环境
unix{
    LIBS += -L/opt/opencv4-imx6ull/lib -lopencv_world
    INCLUDEPATH += /opt/opencv4-imx6ull/include/opencv4
    INCLUDEPATH += /opt/opencv4-imx6ull/include/opencv4/opencv2
    INCLUDEPATH += /opt/opencv4-imx6ull/include
}
